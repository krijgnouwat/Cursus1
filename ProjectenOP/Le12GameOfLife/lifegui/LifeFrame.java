...
public class LifeFrame extends JFrame implements Runnable {
  ...
  private JButton getVolgendeKnop() {
    if (volgendeKnop == null) {
    	...
    	volgendeKnop.setBounds(14, 298, 90, 31);
    }
    return volgendeKnop;
  }
  private JButton getStartStopKnop() {
    if (startStopKnop == null) {
    	startStopKnop = new JButton("Start");
    	startStopKnop.addActionListener(new ActionListener() {
    	  public void actionPerformed(ActionEvent e) {
    	    startStopKnopAction();
    	  }
    	});
    	startStopKnop.setBounds(117, 298, 90, 31);
    }
  ...
  private JLabel getGenLabel() {
    if (genLabel == null) {
    	...
    	genLabel.setBounds(228, 298, 90, 31);
    }
    return genLabel;
  }
  private JButton getNieuwKnop() {
    if (nieuwKnop == null) {
    	...
    	nieuwKnop.setBounds(336, 298, 100, 31);
    }
    return nieuwKnop;
  }
